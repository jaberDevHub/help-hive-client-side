...
const Navbar = () => {
  ...
  const profileDropdown = (
    <ul className="menu menu-sm dropdown-content z-[1] mt-3 p-3 shadow-lg bg-base-100 rounded-lg border border-base-200 w-48">
       <li className="p-2 font-semibold border-b border-base-200">{user?.displayName}</li>
      <li><Link to="/create-event" className="font-medium hover:text-primary transition-colors duration-200 w-full text-left p-2">Create Event</Link></li>
      <li><Link to="/manage-events" className="font-medium hover:text-primary transition-colors duration-200 w-full text-left p-2">Manage Events</Link></li>
      <li><Link to="/joined-events" className="font-medium hover:text-primary transition-colors duration-200 w-full text-left p-2">Joined Events</Link></li>
      <li className="mt-2">
        <button
          onClick={logOut}
